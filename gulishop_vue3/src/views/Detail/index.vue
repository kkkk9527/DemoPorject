          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd
                  changepirce="0"
                  :class="{ active: saleAttr1.isChecked === '1' }"
                  v-for="saleAttr1 in saleAttr.spuSaleAttrValueList"
                  :key="saleAttr1.id"
                  @click="chooseAttr(saleAttr1, saleAttr.spuSaleAttrValueList)"
                >
                  {{ saleAttr1.saleAttrValueName }}
                </dd>
              </dl>
            </div>
            <div class="cartWrap">
...
export default defineComponent({
  ...
  setup() {
    ...
    function chooseImg(index: number): void {
      ...
      skuInfo.value.skuImageList[index].isDefault = "1";
    }
    /* 购买数量加1 */
    function add(): void {
    ...
    function chooseAttr(thisAttr: any, list: any): void {
      list.forEach((element: any) => {
        element.isChecked = "0";
      });
      thisAttr.isChecked = "1";
    }
    onMounted(() => {
      store.dispatch("detail/getDetail", route.query.skuId);
    });
    return {
