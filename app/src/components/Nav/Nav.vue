      ...
      <div class="sort" v-show="show">
        <div class="all-sort-list2">
          ...
          >
            ...
            <div class="item-list clearfix" v-show="currentIndex == categoryId">
              <div
                class="subitem"
...
.type-nav {
  ...
  .showAnime-enter,.showAnime-leave-to{
      height: 0px;
      opacity: 0;
    }
  }
  .showAnime-enter-to,.showAnime-leave{
    height: 461px;
    opacity: 1;
  }
  .showAnime-enter-active,.showAnime-leave-active{
